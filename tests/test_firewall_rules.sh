...
assert_contains "iptables -A INPUT -p udp -s 9.9.9.9 --sport 53 -j ACCEPT"
assert_contains "iptables -A INPUT -p tcp -s 9.9.9.9 --sport 53 -j ACCEPT"
...
assert_contains "ip6tables -A INPUT -p udp -s 2001:4860:4860::8888 --sport 53 -j ACCEPT"
assert_contains "ip6tables -A INPUT -p tcp -s 2001:4860:4860::8888 --sport 53 -j ACCEPT"
